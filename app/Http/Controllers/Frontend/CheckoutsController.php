    ...
    public function store(Request $request){
        ...
        if($request->payment_short_name != 'cash_in'){
            if($request->transaction_id == NULL || empty($request->transaction_id)){
                session()->flush('sticky_error', 'Please give transaction Id for your payment');
                return back();
            }
        }
        ...
        session()->flush('success', 'Your order has taken successfully !!! Please wait admin will soon confirm it.');
