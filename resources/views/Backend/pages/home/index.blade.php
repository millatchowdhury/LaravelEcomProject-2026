                ...
                <div class="card-body">
                  ...
                  <div class="fluid-container">
                    <div class="row ticket-card mt-3 pb-2 border-bottom">
                      <div class="col-1">
                        <img class="img-sm rounded-circle" src="{{ asset('Backend/assets') }}/images/faces/face1.jpg" alt="profile image">
                      </div>
                    ...
                    <div class="row ticket-card mt-3 pb-2 border-bottom">
                      <div class="col-1">
                        <img class="img-sm rounded-circle" src="{{ asset('Backend/assets') }}/images/faces/face2.jpg" alt="profile image">
                      </div>
                      <div class="ticket-details col-9">
                        <div class="d-flex">
                    ...
                    <div class="row ticket-card mt-3 pb-2 border-bottom">
                      <div class="col-1">
                        <img class="img-sm rounded-circle" src="{{ asset('Backend/assets') }}/images/faces/face3.jpg" alt="profile image">
                      </div>
                      <div class="ticket-details col-9">
                        <div class="d-flex">
                    ...
                    <div class="row ticket-card mt-3 pb-2 border-bottom">
                      <div class="col-1">
                        <img class="img-sm rounded-circle" src="{{ asset('Backend/assets') }}/images/faces/face4.jpg" alt="profile image">
                      </div>
                      <div class="ticket-details col-9">
                        <div class="d-flex">
                    ...
                    <div class="row ticket-card mt-3 pb-2">
                      <div class="col-1">
                        <img class="img-sm rounded-circle" src="{{ asset('Backend/assets') }}/images/faces/face5.jpg" alt="profile image">
                      </div>
                      <div class="ticket-details col-9">
                        <div class="d-flex">
