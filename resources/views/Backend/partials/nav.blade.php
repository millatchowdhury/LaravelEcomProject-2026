<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
        <a class="navbar-brand brand-logo" href="{{ route('admin.index') }}"><img src="{{ asset('Backend/assets') }}/images/logo.svg" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="{{ route('admin.index') }}"><img src="{{ asset('Backend/assets') }}/images/logo-mini.svg" alt="logo"/></a>
      </div>
        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item d-none d-lg-block">
            <a class="nav-link" href="#">
              <img class="img-xs rounded-circle" src="{{ asset('Backend/assets') }}/images/faces/face4.jpg" alt="">
            </a>
          </li>
        </ul>
